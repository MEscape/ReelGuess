...
/**
 * Read-only settings display shown to non-host players in the waiting room.
 *
 * Iterates `SETTINGS_CONFIG` so it automatically reflects any setting added
 * to the config — no changes needed here.
 */
