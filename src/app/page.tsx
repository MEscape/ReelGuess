  ...
  return (
    <main className="min-h-dvh flex flex-col items-center justify-center px-4 py-10 pb-safe">
      ...
      <div className="text-center mb-12 max-w-lg">
        ...
        <p className="text-base text-zinc-300 mt-2 font-bold">
          Guess which friend liked the Reel!
        </p>
        <div className="mt-5 flex flex-col gap-1.5 text-sm text-zinc-500">
          <p>
            🎮{" "}
            <span className="text-zinc-300 font-semibold">Create a lobby</span>{" "}
            and invite friends
          </p>
          <p>
            📱{" "}
            <span className="text-zinc-300 font-semibold">Import liked Reels</span>{" "}
            from Instagram
          </p>
          <p>
            🏆{" "}
            <span className="text-zinc-300 font-semibold">Guess & score</span> to
            win!
          </p>
        </div>
      </div>
      ...
      <div className="w-full max-w-sm flex flex-col gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-zinc-600 text-xs font-black uppercase">or</span>
          <div className="flex-1 h-px bg-zinc-800" />
        </div>
