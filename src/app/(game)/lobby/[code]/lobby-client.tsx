...
/**
 * Hydration wrapper for the lobby page — brutalist redesign.
 *
 * `playerId` is null on SSR + first render, populated after mount.
 * Subscribes to lobby status and redirects all players on game start.
 */
export function LobbyClient({ lobby }: Props) {
    ...
    return (
        <main className="min-h-dvh py-8 pb-safe">
            <LobbyRoom lobby={lobby} currentPlayerId={playerId} />
        </main>
    )
}
